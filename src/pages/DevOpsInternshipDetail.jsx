...
const CURRICULUM = [
  {
    ...
    count: 7,
    topics: ['DevOps Culture & Principles','SDLC Overview','Agile & Scrum Basics','DevOps Toolchain','CI/CD Concepts','DevOps vs Traditional IT','Career Paths in DevOps'],
  },
  {
    title: 'Linux & Shell Scripting',
    count: 8,
    topics: ['Linux Fundamentals','File System & Permissions','Process Management','Networking Basics','Bash Scripting','Shell Variables & Loops','Cron Jobs','SSH & Remote Access'],
  },
  {
    title: 'Git & Version Control',
    count: 6,
    topics: ['Git Basics','Branching & Merging','Pull Requests','GitHub / GitLab','Git Workflows (GitFlow)','Git Best Practices'],
  },
  {
    title: 'Docker & Containerisation',
    count: 8,
    topics: ['Docker Architecture','Docker Images & Containers','Dockerfile','Docker Compose','Docker Networking','Docker Volumes','Container Registry','Multi-Stage Builds'],
  },
  {
    title: 'Kubernetes (K8s)',
    count: 9,
    topics: ['Kubernetes Architecture','Pods & Deployments','Services & Ingress','ConfigMaps & Secrets','Persistent Volumes','Namespaces','Helm Charts','RBAC','Horizontal Pod Autoscaling'],
  },
  {
    title: 'CI/CD with Jenkins & GitHub Actions',
    count: 8,
    topics: ['Jenkins Installation & Setup','Jenkinsfile (Pipeline as Code)','Multi-Branch Pipelines','Integration with Git','GitHub Actions Workflows','Automated Testing in CI','Artifact Management','Deployment Automation'],
  },
  {
    title: 'Ansible — Configuration Management',
    count: 6,
    topics: ['Ansible Architecture','Inventory & Playbooks','Roles & Variables','Conditionals & Loops','Ansible Vault','Idempotency & Best Practices'],
  },
  {
    title: 'Terraform — Infrastructure as Code',
    count: 7,
    topics: ['IaC Concepts','Terraform Basics','Providers (AWS/Azure/GCP)','State Management','Modules','Terraform Cloud','Real-World IaC Project'],
  },
  {
    title: 'Cloud Platforms (AWS / Azure / GCP)',
    count: 9,
    topics: ['Cloud Computing Concepts','AWS Core Services (EC2, S3, RDS, VPC)','Azure Core Services','GCP Core Services','Cloud Networking','IAM & Security','Load Balancers & Auto Scaling','Cloud Monitoring','Serverless Functions'],
  },
  {
    title: 'Monitoring & Observability',
    count: 6,
    topics: ['Prometheus & Grafana','Application Logging (ELK Stack)','Alerting & Incident Response','Distributed Tracing','Cloud-Native Monitoring','SRE Practices'],
  },
  {
    title: 'Capstone Projects',
    count: 4,
    topics: ['End-to-End CI/CD Pipeline Project','Kubernetes Production Deployment','Multi-Cloud Infrastructure with Terraform','Final Capstone Presentation'],
  },
]

const BATCHES = [
  { course:'DevOps with Cloud Internship', faculty:'Real-Time Expert', date:'Jun 2026', time:'Flexible', mode:'online',  type:'Online',  link:'Join' },
  { course:'DevOps with Cloud Internship', faculty:'Real-Time Expert', date:'Jun 2026', time:'Flexible', mode:'offline', type:'Offline', link:'Join' },
]

const FEATURES = [
  { Icon: Code2,         color:'#e05c2a', bg:'#ffedd5', title:'Hands-On Real-World Projects',    desc:'Build production-grade CI/CD pipelines, Kubernetes deployments, and multi-cloud IaC setups.' },
  { Icon: GraduationCap, color:'#16a34a', bg:'#dcfce7', title:'Expert-Led Instruction',          desc:'Learn from DevOps practitioners with real industry experience across AWS, Azure, and GCP.' },
  { Icon: BookOpen,      color:'#1565c0', bg:'#dbeafe', title:'Capstone & Full-Stack Projects',  desc:'Multiple capstone projects covering Docker, Kubernetes, Terraform, Jenkins, and cloud platforms.' },
  { Icon: Award,         color:'#dc2626', bg:'#fee2e2', title:'Internship Certification',         desc:'Earn a certificate validating practical DevOps and cloud engineering experience.' },
  { Icon: Headphones,    color:'#0891b2', bg:'#cffafe', title:'24/7 Intern Support',             desc:'Round-the-clock guidance, dedicated mentor sessions, and doubt-clearing throughout the program.' },
  { Icon: Briefcase,     color:'#9333ea', bg:'#f3e8ff', title:'Remote Internship Options',       desc:'Location-flexible remote internship with access to cloud lab environments included.' },
]

const REVIEWS = [
  { name:'Kiran Rao',      course:'DevOps with Cloud Internship', rating:5, initials:'KR', color:'#1565c0', text:'This internship gave me real DevOps exposure that I could not get from online courses alone. The Kubernetes and Terraform capstone projects are exactly what companies look for.' },
  { name:'Priya Sharma',   course:'DevOps with Cloud Internship', rating:5, initials:'PS', color:'#e05c2a', text:'Excellent 45-day program. The CI/CD Jenkins pipeline and GitHub Actions sections are particularly practical. I built a real end-to-end deployment that is now in my GitHub portfolio.' },
  { name:'Sumanth Reddy',  course:'DevOps with Cloud Internship', rating:5, initials:'SR', color:'#2e7d32', text:'The cloud platform coverage across AWS, Azure, and GCP is impressive. The mentor was always available and the monitoring section with Prometheus and Grafana was genuinely professional-level.' },
  { name:'Divya Menon',    course:'DevOps with Cloud Internship', rating:4, initials:'DM', color:'#6a1b9a', text:'Great program for getting into DevOps. The Ansible and Terraform modules were thorough. The capstone presentation gave me experience explaining technical decisions — very useful for interviews.' },
]

const RELATED = [
  { title:'Terraform Associate 003',       slug:'terraform-associate-certification-training-003',  icon:'🏗️' },
  { title:'Data Science Internship',       slug:'internship-program-on-data-science',              icon:'📊' },
...
export default function DevOpsInternshipDetail() {
  const [activeTab,    setActiveTab]    = useState('overview')
  const [trainingType, setTrainingType] = useState('Online')
  const [openSections, setOpenSections] = useState({ 0: true })
  const [formData,     setFormData]     = useState({ name:'', email:'', mobile:'', course:'DevOps with Cloud Internship', mode:'Online' })
    ...
    <div className="fsj-page">
      ...
      <div className="fsj-breadcrumb-bar"><div className="fsj-container">
        <nav className="fsj-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>DevOps with Cloud Internship Program</span>
        </nav>
      </div></div>

      <section className="fsj-header" ref={headerRef}>
        <div className="fsj-banner">
          <img src="https://images.nareshit.com/internship-on-devops-with-multicloud-online-training.jpg"
            alt="Internship Program on DevOps with Cloud" className="fsj-banner__img"
          ...
          <div className="fsj-banner__overlay"><div className="fsj-container">
            <h1 className="fsj-banner__title">Internship Program on DevOps with Cloud</h1>
            <p className="fsj-banner__sub">45 Days — Docker, Kubernetes, CI/CD, Terraform & Multi-Cloud Real-World Projects</p>
          </div></div>
        </div>
        ...
        <main className="fsj-content">
          ...
          {activeTab === 'overview' && (
            <div className="fsj-panel">
              ...
              <p className="fsj-para">The DevOps with Cloud Internship Program provides hands-on experience with real-world DevOps workflows, focusing on CI/CD pipelines, containerisation, and cloud services. Participants work with Docker, Kubernetes, Ansible, Terraform, and Jenkins while gaining practical expertise in deploying cloud-based applications across AWS, Azure, and GCP.</p>
              <h3 className="fsj-sub-title">Course Description</h3>
              <p className="fsj-para">This 45-day intensive internship covers the complete modern DevOps toolchain. Starting from Linux fundamentals and Git, the curriculum progresses through Docker, Kubernetes, Jenkins CI/CD, Ansible configuration management, Terraform IaC, and multi-cloud deployment — mirroring real enterprise DevOps environments.</p>
              <p className="fsj-para">Multiple capstone projects ensure participants graduate with production-grade experience and a strong portfolio to demonstrate to prospective employers.</p>
              <h3 className="fsj-sub-title">Course Objectives</h3>
              <ul className="fsj-bullet-list">
                <li>Master DevOps culture, automation workflows, and CI/CD practices</li>
                <li>Work with containerisation technologies — Docker and Kubernetes</li>
                <li>Implement CI/CD pipelines with Jenkins and GitHub Actions</li>
                <li>Manage cloud infrastructure across AWS, Azure, or GCP</li>
                <li>Automate infrastructure provisioning with Terraform and Ansible</li>
                <li>Set up monitoring and observability with Prometheus and Grafana</li>
                <li>Earn a DevOps internship certificate upon successful completion</li>
              </ul>
              <h3 className="fsj-sub-title">Prerequisites</h3>
              <ul className="fsj-bullet-list">
                <li>Basic DevOps and cloud computing understanding</li>
                <li>Linux command line and scripting familiarity</li>
                <li>Git version control knowledge</li>
                <li>Interest in automation and infrastructure management</li>
              </ul>
          ...
          {activeTab === 'certificate' && (
            <div className="fsj-panel">
              ...
              <p className="fsj-para">Upon successful completion you will receive an official DevOps with Cloud Internship Certificate from Pro Training Tech, validating your hands-on experience with Docker, Kubernetes, CI/CD, Terraform, Ansible, and cloud platforms.</p>
              <div className="fsj-cert-img-wrap">
                <img src="https://nareshit.com/wp-content/uploads/2023/01/Naresh-IT-Certificate.png" alt="Internship Certificate" className="fsj-cert-img"
                  onError={e => { e.target.style.display='none'; e.target.parentElement.innerHTML=`<div class="fsj-cert-placeholder"><div class="fsj-cert-placeholder__inner"><div class="fsj-cert-placeholder__logo">Pro Training Tech</div><div class="fsj-cert-placeholder__title">Internship Certificate</div><div class="fsj-cert-placeholder__course">DevOps with Cloud Internship</div><div class="fsj-cert-placeholder__line"></div><div class="fsj-cert-placeholder__name">Student Name</div></div></div>` }} />
              </div>
        ...
        <aside className="fsj-sidebar">
          ...
          <div className="fsj-enquiry-card">
            ...
            <form className="fsj-enquiry-form" onSubmit={handleFormSubmit}>
              ...
              <div className="fsj-form-field"><select name="course" value={formData.course} onChange={handleFormChange}><option>DevOps with Cloud Internship</option><option>Data Science Internship</option><option>Python Internship</option><option>Terraform Associate 003</option></select></div>
      ...
      <div className="fsj-salary-bar"><div className="fsj-container"><div className="fsj-salary-bar__inner">
        <div className="fsj-salary-bar__label">Average package of course <strong>(DevOps with Cloud Internship)</strong></div>
