...
const CURRICULUM = [
  {
    ...
    count: 5,
    topics: ['Python History & Features','IDE Setup (VS Code / PyCharm)','First Python Program','Interactive Shell','Script Mode'],
  },
  {
    title: 'Python Fundamentals',
    count: 8,
    topics: ['Variables & Data Types','Strings & String Methods','Lists & Tuples','Dictionaries & Sets','Operators','Control Statements','Loops (for / while)','Comprehensions'],
  },
  {
    title: 'Functions & OOP',
    count: 8,
    topics: ['Defining Functions','*args & **kwargs','Lambda Functions','Decorators','Classes & Objects','Inheritance','Polymorphism','Exception Handling'],
  },
  {
    title: 'Data Structures & Algorithms',
    count: 6,
    topics: ['Stacks & Queues','Linked Lists','Sorting Algorithms','Searching Algorithms','Recursion','Complexity Analysis'],
  },
  {
    title: 'NumPy & Pandas',
    count: 8,
    topics: ['NumPy Arrays','Array Operations','Broadcasting','Pandas Series & DataFrames','Data Loading (CSV/Excel)','Data Cleaning','GroupBy & Aggregation','Merge & Join'],
  },
  {
    title: 'Data Visualisation',
    count: 5,
    topics: ['Matplotlib Basics','Line, Bar & Scatter Plots','Seaborn Heatmaps','Plotly Interactive Charts','EDA Dashboard'],
  },
  {
    title: 'SQL with Python',
    count: 5,
    topics: ['SQLite / MySQL Basics','CRUD with Python','SQLAlchemy ORM','Pandas + SQL Integration','Database Projects'],
  },
  {
    title: 'Frontend Development',
    count: 5,
    topics: ['Flask Web Framework','Tkinter GUI','Streamlit Dashboards','REST API Basics','Deploying Flask Apps'],
  },
  {
    title: 'Machine Learning Basics',
    count: 6,
    topics: ['Scikit-Learn Overview','Linear & Logistic Regression','Decision Trees','Model Evaluation','Feature Engineering','Pipeline Building'],
  },
  {
    title: 'Web Scraping & APIs',
    count: 4,
    topics: ['Requests & BeautifulSoup','Scrapy Basics','Working with REST APIs','JSON Data Handling'],
  },
  {
    title: 'Mini & Capstone Projects',
    count: 5,
    topics: ['E-commerce Data Analysis','Stock Price Predictor','AI Chatbot (basic)','Twitter Sentiment Analysis','Final Capstone Project'],
  },
]

const BATCHES = [
  { course:'Python Internship', faculty:'Real-Time Expert', date:'Jun 2026', time:'Flexible', mode:'online',  type:'Online',  link:'Join' },
  { course:'Python Internship', faculty:'Real-Time Expert', date:'Jun 2026', time:'Flexible', mode:'offline', type:'Offline', link:'Join' },
]

const FEATURES = [
  { Icon: Code2,         color:'#e05c2a', bg:'#ffedd5', title:'Hands-On Daily Sessions',         desc:'2-hour practical coding sessions every day with real-time AI Virtual Lab experience.' },
  { Icon: BookOpen,      color:'#1565c0', bg:'#dbeafe', title:'Industry-Aligned Curriculum',     desc:'From Python basics through NumPy, Pandas, and ML — skills employers actively seek.' },
  { Icon: GraduationCap, color:'#16a34a', bg:'#dcfce7', title:'Flexible Duration',               desc:'45-day structured program accommodating both academic and professional schedules.' },
  { Icon: Award,         color:'#dc2626', bg:'#fee2e2', title:'Internship Certification',         desc:'Receive a certificate upon completion validating your practical Python experience.' },
  { Icon: Headphones,    color:'#0891b2', bg:'#cffafe', title:'24/7 Intern Assistance',           desc:'Round-the-clock guidance, dedicated mentor support, and doubt-clearing sessions.' },
  { Icon: Briefcase,     color:'#9333ea', bg:'#f3e8ff', title:'Capstone Projects & Assignments',  desc:'Real capstone projects including e-commerce analysis, AI chatbot, and EDA work.' },
]

const REVIEWS = [
  { name:'Pooja Krishnan',  course:'Python Internship', rating:5, initials:'PK', color:'#1565c0', text:'The Python internship gave me exactly what I needed to transition into data science. The daily hands-on sessions and capstone project became the centrepiece of my portfolio.' },
  { name:'Rohan Gupta',     course:'Python Internship', rating:5, initials:'RG', color:'#e05c2a', text:'Excellent program structure. Going from Python basics to machine learning in 45 days is ambitious but the curriculum makes it achievable. The AI Virtual Lab is fantastic.' },
  { name:'Sanya Mehta',     course:'Python Internship', rating:5, initials:'SM', color:'#2e7d32', text:'The NumPy, Pandas, and Streamlit sections were particularly strong. I built a real dashboard project that impressed interviewers. The mentor was always available to help.' },
  { name:'Aryan Joshi',     course:'Python Internship', rating:4, initials:'AJ', color:'#6a1b9a', text:'Great internship with a solid balance of theory and practice. The web scraping and API modules were a bonus I did not expect. Highly recommended for beginners and intermediates.' },
]
...
export default function PythonInternshipDetail() {
  const [activeTab,    setActiveTab]    = useState('overview')
  const [trainingType, setTrainingType] = useState('Online')
  const [openSections, setOpenSections] = useState({ 0: true })
  const [formData,     setFormData]     = useState({ name:'', email:'', mobile:'', course:'Python Internship', mode:'Online' })
    ...
    <div className="fsj-page">
      ...
      <div className="fsj-breadcrumb-bar"><div className="fsj-container">
        <nav className="fsj-breadcrumb" aria-label="Breadcrumb">
          ...
          <span>Python Internship Program</span>
        </nav>
      </div></div>

      <section className="fsj-header" ref={headerRef}>
        <div className="fsj-banner">
          <img src="https://images.nareshit.com/internship-on-python-online-training.jpg"
            alt="Internship Program on Python" className="fsj-banner__img"
          ...
          <div className="fsj-banner__overlay"><div className="fsj-container">
            <h1 className="fsj-banner__title">Internship Program on Python</h1>
            <p className="fsj-banner__sub">45 Days of Hands-On Python — NumPy, Pandas & Real-World Projects in AI Virtual Lab</p>
          </div></div>
        </div>
        ...
        <main className="fsj-content">
          ...
          {activeTab === 'overview' && (
            <div className="fsj-panel">
              ...
              <p className="fsj-para">The Python Internship Program provides comprehensive Python training with practical exposure to data manipulation, analysis, and automation. Participants engage in daily 2-hour practical sessions, real-world case studies, and a capstone project in a structured 45-day format with AI Virtual Lab access.</p>
              <h3 className="fsj-sub-title">Course Description</h3>
              <p className="fsj-para">Starting from Python fundamentals and progressing through NumPy, Pandas, data visualisation, SQL, Flask, and basic machine learning, the curriculum is designed to make participants job-ready as Python developers or junior data analysts within 45 days.</p>
              <p className="fsj-para">Real capstone projects such as e-commerce data analysis and an AI chatbot ensure students graduate with a strong portfolio to show potential employers.</p>
              <h3 className="fsj-sub-title">Course Objectives</h3>
              <ul className="fsj-bullet-list">
                <li>Master Python fundamentals and standard libraries</li>
                <li>Implement data processing solutions with NumPy and Pandas</li>
                <li>Visualise data effectively using Matplotlib, Seaborn, and Plotly</li>
                <li>Use AI Virtual Lab for coding, debugging, and project work</li>
                <li>Build automation scripts and web scraping tools</li>
                <li>Develop and deploy Flask web applications</li>
                <li>Complete a capstone project and earn an internship certificate</li>
              </ul>
              <h3 className="fsj-sub-title">Prerequisites</h3>
              <ul className="fsj-bullet-list">
                <li>No prior Python experience required</li>
                <li>Basic mathematics knowledge</li>
                <li>Curiosity and willingness to code daily</li>
          ...
          {activeTab === 'certificate' && (
            <div className="fsj-panel">
              ...
              <p className="fsj-para">Upon successful completion you will receive an official Python Internship Certificate from Pro Training Tech, validating your practical experience with Python, NumPy, Pandas, data visualisation, and real-world project development.</p>
              <div className="fsj-cert-img-wrap">
                <img src="https://nareshit.com/wp-content/uploads/2023/01/Naresh-IT-Certificate.png" alt="Internship Certificate" className="fsj-cert-img"
                  onError={e => { e.target.style.display='none'; e.target.parentElement.innerHTML=`<div class="fsj-cert-placeholder"><div class="fsj-cert-placeholder__inner"><div class="fsj-cert-placeholder__logo">Pro Training Tech</div><div class="fsj-cert-placeholder__title">Internship Certificate</div><div class="fsj-cert-placeholder__course">Python Internship Program</div><div class="fsj-cert-placeholder__line"></div><div class="fsj-cert-placeholder__name">Student Name</div></div></div>` }} />
              </div>
        ...
        <aside className="fsj-sidebar">
          ...
          <div className="fsj-enquiry-card">
            ...
            <form className="fsj-enquiry-form" onSubmit={handleFormSubmit}>
              ...
              <div className="fsj-form-field"><select name="course" value={formData.course} onChange={handleFormChange}><option>Python Internship</option><option>Data Science Internship</option><option>DevOps Internship</option><option>Full Stack Python</option></select></div>
      ...
      <div className="fsj-salary-bar"><div className="fsj-container"><div className="fsj-salary-bar__inner">
        <div className="fsj-salary-bar__label">Average package of course <strong>(Python Internship)</strong></div>
